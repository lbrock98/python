...
portfolio = urllib.request.urlopen(f'https://api.census.gov/data/{year}/pep/population?get=NAME,POP&for=us:*&key={CENSUS_KEY}')
...
state = urllib.request.urlopen(f'https://api.census.gov/data/{year}/pep/population?get=NAME,POP&for=state:*&key={CENSUS_KEY}')
...
msa = urllib.request.urlopen(f'https://api.census.gov/data/{year}/pep/population?get=NAME,POP&for=metropolitan%20statistical%20area/micropolitan%20statistical%20area:*&key={CENSUS_KEY}')
...
state_fips = pd.read_csv("/Users/LBrock/Documents/censusData/state_fips.csv")
...
county = urllib.request.urlopen(f'https://api.census.gov/data/{year}/pep/population?get=NAME,POP&for=county:*&in=state:*&key={CENSUS_KEY}')
...
#export to csv 
final.to_csv('/Users/LBrock/Documents/censusData/population/others_pop.csv', header=False, index=False)
...
file = open('/Users/LBrock/Documents/censusData/population/others_pop.csv')
